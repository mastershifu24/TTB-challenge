...
export const DEMO_SAMPLES: DemoSample[] = [
  ...
  },
  {
    ...
    name: "Review — soft brand casing",
    description:
      "Brand casing differs (STONE'S THROW vs Stone's Throw). Soft match — needs agent judgment, not auto-fail.",
  ...
  {
    id: "brand-mismatch",
    name: "Fail — brand name mismatch",
    description: "Application is OLD TOM DISTILLERY; label shows BLACK RIDGE.",
    imagePath: "/samples/brand-mismatch.svg",
    application: {
      brandName: "OLD TOM DISTILLERY",
      classType: "Kentucky Straight Bourbon Whiskey",
      alcoholContent: "45% Alc./Vol. (90 Proof)",
    ...
    extracted: {
      ...
      governmentWarningRemainderBold: false,
      rawText: null,
      confidenceNotes: "Different brand on label.",
    },
  },
  {
    id: "abv-mismatch",
    name: "Fail — ABV mismatch",
  ...
  },
  {
    ...
    name: "Fail — net contents mismatch",
    description: "Application says 750 mL; label shows 1 L.",
    imagePath: "/samples/net-contents-mismatch.svg",
    application: {
      brandName: "MAPLE FORK",
  ...
  },
  {
    ...
    name: "Fail — warning prefix title case",
    description:
  ...
  {
    id: "warning-wording",
    name: "Fail — warning wording changed",
    description:
      "Prefix is correct, but body text is paraphrased instead of the required statement.",
    imagePath: "/samples/warning-wording.svg",
    application: {
      brandName: "COPPER LANTERN",
    ...
    extracted: {
      ...
      netContents: "750 mL",
      governmentWarning:
        "GOVERNMENT WARNING: Drinking alcohol during pregnancy can cause birth defects. Please drink responsibly and do not drive after drinking.",
      governmentWarningPrefixExact: true,
      governmentWarningHeaderBold: true,
      governmentWarningRemainderBold: false,
      rawText: null,
      confidenceNotes: "Warning body is paraphrased.",
    },
  },
  {
    id: "missing-warning",
    name: "Fail — missing government warning",
